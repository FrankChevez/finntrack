...
export function MonthlyTopTransactions({ bgColor, transactions, onInView }: Props) {
  return (
    <WrappedSection bgColor={bgColor} Icon={Trophy} label="Top gastos del mes" onInView={onInView}>
      {transactions.length > 0 ? (
        ...
        <div className="wrapped-stat-sub wrapped-anim">Sin transacciones este mes.</div>
      )}
    </WrappedSection>
  )
}
